...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.utilspot.app/emi-calculator",
    siteName: "UtilSpot",
  },
  alternates: { canonical: "https://www.utilspot.app/emi-calculator" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "EMI Calculator", item: "https://www.utilspot.app/emi-calculator" },
  ],
};
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap gap-3 mb-2">
          <span className="inline-flex items-center gap-1.5 text-xs bg-[#F1F5F9] text-[#475569] px-3 py-1 rounded-full font-medium">
            ...
            Last updated: June 2025 · Rates verified against RBI guidelines
          </span>
          <span className="inline-flex items-center gap-1.5 text-xs bg-[#F1F5F9] text-[#475569] px-3 py-1 rounded-full font-medium">
            <span className="w-2 h-2 rounded-full bg-emerald-500 inline-block" />
            Calculated by 18,400+ users this month
          </span>
        </div>
