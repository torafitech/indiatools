...
const tools = [
  ...
  { slug: "/construction-cost-calculator",      name: "Construction Cost Estimator", description: "Estimate home construction cost in your city. Basic, standard, and premium rates for 30+ cities.", category: "Real Estate & Construction", popular: false, icon: "🏗️", status: "live" },
  { slug: "/land-area-converter",               name: "Land Area Unit Converter",     description: "Convert Sq Ft, Acre, Guntha, Bigha, Katha, Cent, Ankanam & Ground. State-specific values included.", category: "Real Estate & Construction", popular: false, icon: "📐", status: "live" },
