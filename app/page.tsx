...
const tools = [
  ...
  { slug: "/business-name-generator",     name: "AI Business Name Generator",  description: "Generate 10 unique business name ideas with taglines using Claude AI. Free.",               category: "Business",  popular: false, icon: "🤖", status: "live" },
  { slug: "/ats-resume-checker",          name: "ATS Resume Checker",           description: "AI-powered ATS resume scanner. Get instant match score, missing keywords, and improvement tips.", category: "Career",    popular: false, icon: "📄", status: "live" },
  { slug: "/legal-document-generator",   name: "AI Legal Document Generator",  description: "Generate NDA, rent agreements, and freelance contracts for India instantly with AI.",          category: "Legal",     popular: false, icon: "⚖️", status: "live" },
  { slug: "/social-media-calendar",      name: "AI Social Media Calendar",     description: "Generate 30 days of Instagram, LinkedIn, and Twitter posts with captions and hashtags.",       category: "Marketing", popular: false, icon: "📅", status: "live" },
  ...
  { slug: "/color-palette-generator",    name: "AI Color Palette Generator",   description: "Generate brand color palettes from text description. Export to CSS, Tailwind, or hex.",        category: "Design",    popular: false, icon: "🎨", status: "live" },
  { slug: "/readme-generator",           name: "AI README Generator",          description: "Generate a complete professional README.md from your project description. Copy as Markdown.",   category: "Developer", popular: false, icon: "📝", status: "live" },
  ...
  { slug: "/email-subject-tester",       name: "Email Subject Line Tester",    description: "Test email subjects for open rate potential. Spam detection, length check, AI alternatives.",  category: "Marketing", popular: false, icon: "✉️", status: "live" },
  ...
  { slug: "/meeting-agenda-generator",   name: "AI Meeting Agenda Generator",  description: "Generate structured meeting agendas with time blocks from your topic list. Copy as Markdown.",  category: "Productivity", popular: false, icon: "📋", status: "live" },
