...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "CTC to In-Hand Calculator", item: "https://www.utilspot.app/salary-calculator" },
  ],
};
        ...
        <section className="mt-8 bg-white rounded-xl border border-gray-200 p-6 prose prose-gray max-w-none">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 text-sm text-gray-700">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1">
              ...
              <span className="font-bold text-[#0F2447] mt-1">In-Hand Monthly:</span><span className="font-bold text-[#0F2447] mt-1">≈ ₹81,000/mo</span>
            </div>
          </div>
