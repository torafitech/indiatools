    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <input
            ...
            className="w-28 text-right text-sm font-semibold text-gray-900 border border-gray-300 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
      ...
      <div className="relative">
        ...
        <div className="flex justify-between text-xs text-gray-400 mt-1">
          ...
          <span className="font-medium text-blue-600">{formatDisplay(value, format, unit)}</span>
